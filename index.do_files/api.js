define(function() {
    return {
        ...
        saveCxxxRecord: WIS_CONFIG.ROOT_PATH + '/sys/swmxsqjapp/MobileServiceStudentApply/saveCxxxRecord.do',
        ...
        checkCanShow: WIS_CONFIG.ROOT_PATH + '/sys/swmxsqjapp/MobileServiceStudentApply/checkCanShow.do',
        getAuthPhoto:function(xsbh,dztj){
    		return WIS_CONFIG.ROOT_PATH + '/sys/swmxsqjapp/MobileServiceStudentApply/getAuthPhoto.do?XSBH='+xsbh;
    	}
    };
});